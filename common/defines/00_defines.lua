...
NGame = {
	...
	HANDS_OFF_START_TAG = "KOR",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
},
...
NDiplomacy = {
	...
	NAP_EXPIRY_MONTHS = 96,                         -- NAPs expire after this many months
	...
	TENSION_TIME_SCALE_START_DATE = "1934.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
